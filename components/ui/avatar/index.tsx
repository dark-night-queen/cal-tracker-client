...
const avatarStyle = tva({
  base: 'rounded-full justify-center items-center relative bg-background-0 dark:bg-gray-800 group-[.avatar-group]/avatar-group:-ml-2.5',
  variants: {
    size: {
      xs: 'w-6 h-6',
      sm: 'w-8 h-8',
...
const avatarFallbackTextStyle = tva({
  base: 'text-background-900 font-semibold overflow-hidden text-transform:uppercase web:cursor-default',
